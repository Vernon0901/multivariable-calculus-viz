document.addEventListener('DOMContentLoaded', () => {
    ...
    barHeader.addEventListener('click', () => {
        ...
        if (wasCollapsed && !mathBar.classList.contains('collapsed')) mathBar.classList.add('collapsed');
    });
    ...
    mathBarHeader.addEventListener('click', () => {
        ...
        if (wasCollapsed && !contextBar.classList.contains('collapsed')) contextBar.classList.add('collapsed');
    });
